<?php
    ...
    if(verificar_datos("[a-zA-Z]((\.|_|-)?[a-zA-Z0-9]+){3}",$codigo)){
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
	...
	if($_FILES['producto_foto']['name']!="" && $_FILES['producto_foto']['size']>0){
		...
		if(!move_uploaded_file($_FILES['producto_foto']['tmp_name'],$img_dir.$foto)){
            ...
            echo '
            <div class="notification is-danger is-light">
                <strong>¡Directorio de la imagen:!</strong><br>
            	"'.$img_dir.'" 
            </div>
           ';
           echo '
           <div class="notification is-danger is-light">
               <strong>¡Estension:!</strong><br>
               "'.$img_ext.'" 
           </div>
          ';
           ...
           echo '
           <div class="notification is-danger is-light">
               <strong>¡Directorio temporal:!</strong><br>
               "'.$_FILES['producto_foto']['tmp_name'].'" 
           </div>
          ';
           ...
           echo '
           <div class="notification is-danger is-light">
               <strong>¡Nombre final de la imagen:!</strong><br>
               "'.$foto.'" 
           </div>
          ';
